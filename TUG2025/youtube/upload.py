#!/usr/bin/env python3
"""
Upload the finished TUG 2025 talk videos to YouTube via the Data API.

For each talk it uploads ../runners/<token>/<token>-final.mp4 with
    title       "TUG 2025 — <speaker> — <title>"   (see ytcommon.make_title)
...
def main():
    ...
    if not args.dry_run and done:
        print("Tip: run  make-playlist.py --title \"TUG 2025\"  to add them in program order.")
