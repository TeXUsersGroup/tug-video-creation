#!/usr/bin/env python3
"""
Put all the TUG 2026 talk videos into a playlist, in conference-program order.
...
order. Safe to re-run.
    ...
    python3 make-playlist.py --title "TUG 2026"               # find or create it
    python3 make-playlist.py --playlist-id PLxxxx             # use an existing one
    python3 make-playlist.py --title "TUG 2026" --privacy unlisted
    ...
    if args.playlist_id:
        ...
        if pid:
            ...
            pid = yc.create_playlist(yt, args.title, args.privacy,
                                     description="Talks from the TUG 2026 conference, "
